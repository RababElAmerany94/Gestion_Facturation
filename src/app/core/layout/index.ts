...
export { GetNameOfUserById } from '../../pipes/get-name-of-user-by-id.pipe';
export { TruncatePipe } from '../../pipes/truncate.pipe';
export { RoundingNumberPipe } from '../../pipes/rounding-number.pipe';
export { OrderListArticle } from '../../pipes/order-list-article.pipe';
