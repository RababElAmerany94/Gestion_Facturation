...
// Layout
import { LayoutConfigService, MenuOptions, OffcanvasOptions, TranslationService, MenuConfigService } from 'app/core/layout';
...
export class AsideLeftComponent implements OnInit, AfterViewInit {
    ...
    isStringEmptyOrNull(value: string) {
        return StringHelper.isEmptyOrNull(value);
    }
}
